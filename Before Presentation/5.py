...
5.	Entropy(BV)(73)
6.	URL Digit Count(AM)(38)
7.	URL Letter Count(AS)(44)
8.	Number of Special Characters in URL(BF)(57)
9.	Number of dots in URL(AI)(34)
'''
from sklearn import tree
import matplotlib.pyplot as plt 
import seaborn 
def plotTree( features , ratio_of_train , max_depth , feature_names=[] ): 
    ...
    # print("X")
    plt.savefig(".\\5\\" + str( max_depth ) + "decision tree.png")
...
while( len( features ) > 0 and max_acc > 0.85 ):
    ...
    print( "next_remove:" + features_names[ next_remove_feature_index ] ) 
    i_th = i_th + 1  
